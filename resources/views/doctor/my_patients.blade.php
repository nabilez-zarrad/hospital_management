...
<head>
	...
	<body>
		...
		<div class="main-wrapper">
			...
			<div class="content">
				<div class="container-fluid">
					<div class="row">@include('doctor.sidbar')
									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											<div class="pro-widget-content">
												<div class="profile-info-widget">
													<a href="patient-profile.html" class="booking-doc-img">
														<img src="{{ asset('front-end/assets/img/patients/patient1.jpg') }}" alt="User Image">
													</a>
													<div class="profile-det-info">
											...
											<div class="pro-widget-content">
												<div class="profile-info-widget">
													<a href="#" class="booking-doc-img">
														<img src="{{ asset('front-end/assets/img/patients/patient2.jpg') }}" alt="User Image">
													</a>
													<div class="profile-det-info">
									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											<div class="pro-widget-content">
												<div class="profile-info-widget">
													<a href="#" class="booking-doc-img">
														<img src="{{ asset('front-end/assets/img/patients/patient3.jpg') }}" alt="User Image">
													</a>
													<div class="profile-det-info">
														<h3>Carl Kelly</h3>
														<div class="patient-details">
									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											<div class="pro-widget-content">
												<div class="profile-info-widget">
													<a href="#" class="booking-doc-img">
														<img src="{{ asset('front-end/assets/img/patients/patient4.jpg') }}" alt="User Image">
													</a>
													<div class="profile-det-info">
									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											<div class="pro-widget-content">
												<div class="profile-info-widget">
													<a href="#" class="booking-doc-img">
														<img src="{{ asset('front-end/assets/img/patients/patient5.jpg') }}" alt="User Image">
													</a>
													<div class="profile-det-info">
														<h3>Gina Moore</h3>
														<div class="patient-details">
									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											<div class="pro-widget-content">
												<div class="profile-info-widget">
													<a href="#" class="booking-doc-img">
														<img src="{{ asset('front-end/assets/img/patients/patient6.jpg') }}" alt="User Image">
													</a>
													<div class="profile-det-info">
														<h3>Elsie Gilley</h3>
														<div class="patient-details">
									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											<div class="pro-widget-content">
												<div class="profile-info-widget">
													<a href="#" class="booking-doc-img">
														<img src="{{ asset('front-end/assets/img/patients/patient7.jpg') }}" alt="User Image">
													</a>
													<div class="profile-det-info">
														<h3>Joan Gardner</h3>
														<div class="patient-details">
									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											<div class="pro-widget-content">
												<div class="profile-info-widget">
													<a href="#" class="booking-doc-img">
														<img src="{{ asset('front-end/assets/img/patients/patient8.jpg') }}" alt="User Image">
													</a>
													<div class="profile-det-info">
									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											<div class="pro-widget-content">
												<div class="profile-info-widget">
													<a href="#" class="booking-doc-img">
														<img src="{{ asset('front-end/assets/img/patients/patient9.jpg') }}" alt="User Image">
													</a>
													<div class="profile-det-info">
									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											<div class="pro-widget-content">
												<div class="profile-info-widget">
													<a href="#" class="booking-doc-img">
														<img src="{{ asset('front-end/assets/img/patients/patient10.jpg') }}" alt="User Image">
													</a>
													<div class="profile-det-info">
														<h3>Robert Rhodes</h3>
														<div class="patient-details">
									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											<div class="pro-widget-content">
												<div class="profile-info-widget">
													<a href="#" class="booking-doc-img">
														<img src="{{ asset('front-end/assets/img/patients/patient11.jpg') }}" alt="User Image">
													</a>
													<div class="profile-det-info">

										...
										<div class="col-md-6">
											<div class="form-group">
												<label>Email <span class="text-danger">*</span></label>
												 <input type="email" class="form-control" {{--value="{{ $medecins->email }}" --}} readonly>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
										...
										<div class="col-md-12">
											...
											<div class="upload-wrap">
												<div class="upload-images">
													<img src="{{ asset('front-end/assets/img/features/feature-01.jpg') }}" alt="Upload Image">
													<a href="javascript:void(0);" class="btn btn-icon btn-danger btn-sm"><i class="far fa-trash-alt"></i></a>
												</div>
												<div class="upload-images">
													<img src="{{ asset('front-end/assets/img/features/feature-02.jpg') }}" alt="Upload Image">
													<a href="javascript:void(0);" class="btn btn-icon btn-danger btn-sm"><i class="far fa-trash-alt"></i></a>
												</div>
											</div>
										</div>

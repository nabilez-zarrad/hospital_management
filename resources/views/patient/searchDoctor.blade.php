                ...
                <div class="doc-info-left">
                    <div class="doctor-img">
                        <a href="{{ route('doctor.profile', $doctor->id) }}">
    						<img src="{{ asset('front-end/assets/img/doctors/doctor-thumb-01.jpg') }}" class="img-fluid" alt="User Image">
						</a>
                    </div>
                    <div class="doc-info-cont">
                        ...
                        <div class="clinic-details">
                            ...
                            <ul class="clinic-gallery">
                                ...
                                <li>
                                    <a href="{{ asset('front-end/assets/img/features/feature-02.jpg') }}" data-fancybox="gallery">
                                        <img src="{{ asset('front-end/assets/img/features/feature-02.jpg') }}" alt="Feature">
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ asset('front-end/assets/img/features/feature-03.jpg') }}" data-fancybox="gallery">
                                        <img src="{{ asset('front-end/assets/img/features/feature-03.jpg') }}" alt="Feature">
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ asset('front-end/assets/img/features/feature-04.jpg') }}" data-fancybox="gallery">
                                        <img src="{{ asset('front-end/assets/img/features/feature-04.jpg') }}" alt="Feature">
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="clinic-services">
                            <span>{{ $doctor->speciality ?? 'General' }}</span>
                ...
                <div class="doc-info-right">
                    <div class="clini-infos">
                        <ul>
                            ...
                            <li><i class="fas fa-map-marker-alt"></i> {{ $doctor->address ?? 'Location not specified' }}</li>
